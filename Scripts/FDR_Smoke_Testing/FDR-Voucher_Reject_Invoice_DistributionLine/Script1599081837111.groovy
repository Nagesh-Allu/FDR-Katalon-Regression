...
//WebUI.click(findTestObject('FDR-VoucherEntry/Voucher/payDate'))
...
WebUI.sendKeys(findTestObject('FDR-VoucherEntry/Voucher/primaryContact'),Datasheet.getValue(
		'primaryContact', 1))
...
//VF.getExpandButton(j)
//String k=Integer.toString(j);
//def xpath1=""//*[contains(@class,'MuiExpansionPanel-root')])[1]//*[contains(@class,'expandIcon')]""
//WebUI.click(findTestObject("(.//*[normalize-space(text()) and normalize-space(.)='$0.00'])[6]/following::*[name()='svg'][4]"),30)
//(//*[contains(@class,'MuiExpansionPanel-root')])[1]//*[contains(@class,'expandIcon')]
...
//WebUI.click(findTestObject('Object Repository/FDR-VoucherEntry/VoucherHeader/PageCount'))
WebUI.delay(3)
//WebUI.sendKeys(findTestObject('Object Repository/FDR-VoucherEntry/VoucherHeader/PageCount'), Keys.chord(Keys.DOWN, Keys.DOWN,Keys.ENTER))
//WebUI.click(findTestObject('Object Repository/FDR-VoucherEntry/VoucherHeader/Select_Pagination_value'))
...
//List pending = WebUI.findWebElements(findTestObject('Object Repository/FDR-VoucherEntry/VoucherHeader/Grid'))

//List<WebElement> listElement = WebUI.findWebElements(findTestObject('Object Repository/FDR-VoucherEntry/VoucherHeader/Grid'))

//List pending = WebUI.findWebElements(findTestObject('Object Repository/FDR-VoucherEntry/VoucherHeader/Grid'), 30)


//int value=pending.size()



//div[@class='jss495 jss552 jss550 jss551']/div[1]
...
//WebUI.click(findTestObject('FDR-Dashboard/VouhcersTable/validateButton')) ////*[text()='Validate'] --//*[@data-id='button-link' ]//*[contains(text(),'Validate')]
...
//WebUI.delay(10)
// Navigate to This page after validated manually selection
/* Distribution Line Reject Start */
...
WebUI.click(findTestObject('FDR-VoucherEntry/DistributionLine/serviceCategory'))
WebUI.sendKeys(findTestObject('FDR-VoucherEntry/DistributionLine/serviceCategory'),'18B1')// required to add/update test data sheet based on program
WebUI.sendKeys(findTestObject('FDR-VoucherEntry/DistributionLine/serviceCategory'), Keys.chord(Keys.DOWN, Keys.ENTER))
...
// Step # 35 -- 1.Login As an account Payable Approver

CF.selectRole('accountsPayableApprover')// ************Validate Voucher manully**********
WebUI.delay(1)
WebUI.click(findTestObject('FDR-Dashboard/Filters/validateFilterButton'))
WebUI.delay(12)
//WebUI.click(findTestObject('FDR-Dashboard/Search/searchInputField'))
...
//def text = {"message":"Cannot read property 'status' of undefined"}
WebUI.click(findTestObject('Object Repository/FDR-Vouchers-States/Print/printCMIAForm'))
WebUI.waitForPageLoad(7)
///html/body/pre
//WebUI.verifyElementText(findTestObject('/FDR-Vouchers-States/Print/bodytext'), 'text')
