...
WebUI.click(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/supplier'))

String label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/supplierReference/SupplierTable/SupplierCode'))
assert label == 'Supplier Code'

label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/supplierReference/SupplierTable/Name'))
assert label == 'Name'
