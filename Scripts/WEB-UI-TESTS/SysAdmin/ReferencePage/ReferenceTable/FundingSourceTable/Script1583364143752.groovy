...
String label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/fundingSourceReference/fundingSourceTable/Description'))
assert label == 'Description'

label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/fundingSourceReference/fundingSourceTable/ServiceCategoryRequired'))
assert label == 'Service Category Required'
