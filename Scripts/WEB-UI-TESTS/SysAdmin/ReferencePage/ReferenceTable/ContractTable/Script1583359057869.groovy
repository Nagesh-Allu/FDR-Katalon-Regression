...
WebUI.click(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/contract'))

String label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/contractReference/contractTable/contractNo'))
assert label == 'Contract No.'
label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/contractReference/contractTable/supplier'))
