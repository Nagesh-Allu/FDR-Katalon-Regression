...
WebUI.click(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/programType'))

String label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/programTypeReference/ProgramTypeTable/Code'))
assert label == 'Code'

label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/programTypeReference/ProgramTypeTable/Description'))
