...
WebUI.click(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/fund'))

String label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/fundReference/FundTable/Description'))
assert label == 'Description'
label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/fundReference/FundTable/Code'))
assert label == 'Code'
