...
String label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/increaseDecreaseLineNumberReference/IncreaseDecreaseLineNumberTable/Description'))
assert label == 'Description'

label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/increaseDecreaseLineNumberReference/IncreaseDecreaseLineNumberTable/Code'))
assert label == 'Code'
