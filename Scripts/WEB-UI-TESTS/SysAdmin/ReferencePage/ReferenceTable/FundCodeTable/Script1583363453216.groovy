...
WebUI.click(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/fundCode'))

String label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/fundCodeReference/FundCodeTable/FundCodeName'))
assert label == 'Fund Code Name'
label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/fundCodeReference/FundCodeTable/ReportingStructure'))
assert label == 'Reporting Structure'
label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/fundCodeReference/FundCodeTable/Account'))
