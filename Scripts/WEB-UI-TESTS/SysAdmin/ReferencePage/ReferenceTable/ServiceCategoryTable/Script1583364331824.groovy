...
String label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/serviceCategoryReference/ServiceCategoryTable/LineNumber'))
assert label == 'Line Number'

label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/serviceCategoryReference/ServiceCategoryTable/ServiceCategory'))
assert label == 'Service Category'

label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/serviceCategoryReference/ServiceCategoryTable/FeederForm'))
assert label == 'Feeder Form'
