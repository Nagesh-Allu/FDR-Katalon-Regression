...
String label = WebUI.getText(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/waiverTypeReference/WaiverTypeTable/WaiverType'))
assert label == 'Waiver Type'
