...
WebUI.click(findTestObject('Object Repository/FDR-System-Admin/FDR-ReferencePage/altAccount'))

label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/altAccountReference/altAccountTable/AltAccountCode'))
assert label == 'Alt Account Code'

label = WebUI.getText(findTestObject('FDR-System-Admin/FDR-ReferencePage/altAccountReference/altAccountTable/AltAccountName'))
assert label == 'Alt Account Name'
