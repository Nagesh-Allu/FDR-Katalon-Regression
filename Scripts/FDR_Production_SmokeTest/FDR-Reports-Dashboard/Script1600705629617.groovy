...
WebUI.verifyElementText(findTestObject('FDR-System-Admin/FDR-Reports/FDR-Report-Dashboard/mbesReportText'), mbesReportTaskName)
WebUI.click(findTestObject('FDR-System-Admin/FDR-Reports/FDR-Report-Dashboard/mbesReportText'))
WebUI.verifyTextPresent('MBES Reports', false, FailureHandling.STOP_ON_FAILURE)
WebUI.back()
...
WebUI.click(findTestObject('FDR-System-Admin/FDR-Reports/FDR-Report-Dashboard/customReportsText'))
WebUI.verifyTextPresent('Custom Reports', false, FailureHandling.STOP_ON_FAILURE)
WebUI.back()
...
WebUI.click(findTestObject('FDR-System-Admin/FDR-Reports/FDR-Report-Dashboard/MBESDataExtracttext'))
WebUI.verifyTextPresent('MBES Data Extract', false, FailureHandling.STOP_ON_FAILURE)
WebUI.back()
