/* Project Name : FDR
 * END_2_END_TC_1-FDR_E2E_FDR-8209-VOUCHER-APPROVAL
 ...
 * Revision History:
 * 10/202/2020 : Linked with Account Number with Account Name .So that Account Number & Alt Account will be update at Voucher Level
 * *******************************************************************************************************/
//Import statements
...
//WebUI.waitForElementPresent(findTestObject('Object Repository/FDR-Vouchers-States/Resume/reviewButton',2))
...
WebUI.setText(findTestObject('FDR-Dashboard/Search/searchInputField'), processorVoucherNumber)
//WebUI.delay(1)
WebUI.waitForElementPresent(findTestObject('Object Repository/FDR-Dashboard/Filters/printFilterButton'),3)
WebUI.click(findTestObject('Object Repository/FDR-Dashboard/Filters/printFilterButton'))
WebUI.waitForElementPresent(findTestObject('FDR-Dashboard/VouhcersTable/printButton'), 3)
