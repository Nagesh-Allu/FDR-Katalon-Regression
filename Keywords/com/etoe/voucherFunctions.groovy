...
public class voucherFunctions {
	public static void createVoucherHeader(dataSheet) {
		...
		WebUI.waitForElementPresent(findTestObject('FDR-VoucherEntry/Voucher/invoiceType'), 5)
		...
		WebUI.waitForElementPresent(findTestObject('FDR-VoucherEntry/Voucher/fundCode'), 5)
		...
		WebUI.waitForElementPresent(findTestObject('FDR-VoucherEntry/Voucher/primaryContact'), 5)
		...
		WebUI.waitForElementPresent(findTestObject('FDR-VoucherEntry/Voucher/secondaryContact'), 5)
		WebUI.waitForElementPresent(findTestObject('FDR-VoucherEntry/Voucher/secondaryContact'), 5)
	...
	public static void createInvoiceLinesAndDistributionLines(invoiceLinesData, distributionLinesData) {
		...
		for (def i = 0; i < invoiceLinesData.size(); i++) {
			...
			WebUI.waitForElementPresent(findTestObject('FDR-VoucherEntry/InvoiceLine/addInvoiceLineButton'), 5)
			if(i == 0) {
